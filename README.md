...
| Ver el [**Asistente de redacción de consignas**](https://mmasias.github.io/pyAI-edu/tools/asistente-consignas-profesor.html) | [Explicación](tools/guia-consignas.md) |
| Usar una plantilla ya lista (declaraciones, consigna, acuerdo TFG/TFM...) | [`docs/plantillas/`](docs/plantillas/) |
| Ver el [**Asistente de declaración del alumno**](https://mmasias.github.io/pyAI-edu/tools/asistente-declaracion-alumno.html) | [Explicación](tools/guia-declaracion.md) |
