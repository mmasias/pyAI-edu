...
| Ver el **Asistente de redacción de consignas** | [Asistente](https://mmasias.github.io/pyAI-edu/tools/asistente-consignas-profesor.html) / [Explicación](tools/asistente-consignas-profesor.md) |
| Usar una plantilla ya lista (declaraciones, consigna, acuerdo TFG/TFM...) | [`docs/plantillas/`](docs/plantillas/) |
| Ver el Asistente de declaración del alumno | [Asistente](https://mmasias.github.io/pyAI-edu/tools/asistente-declaracion-alumno.html) / [Explicación](tools/asistente-declaracion-alumno.md) |
